                            ...
                            <CardContent className="description card-details">
                                <ul id="list">
                                    <li>
                                        ...
                                        e-Banking and Payment solutions using
                                        C++, NodeJS, SQL, Oracle
                                    </li>
                                    <li>
                                        Integration and testing of modules with
                                        the existing banking middleware
                                        architecture
                                    </li>
                                    <li>
                                        Adherent to standards and best practices
                                        around the development process, coding,
                                        and peer reviews
                                    </li>
                                    <li>Database design and development</li>
                                    <li>
                                        Followed the Agile/Scrum methodology and
                                        practices
                                    </li>
                                </ul>
                            </CardContent>
                    ...
                    <Grid xs={12} sm={12} md={9} lg={9} className="card-right">
                        <Card>
                            ...
                            <CardContent className="description card-details">
                                <ul id="list">
                                    <li>
                                        Development and management of e-banking
                                        solutions using C++, SQL
                                    </li>
                                    <li>
                                        Development of financial and
                                        non-financial transactions for banking
                                        systems using ISO 8583 standard for
                                        different channels including Internet
                                        Banking, Mobile Banking, ATMS and others
                                    </li>
                                    <li>Database design and development</li>
                                    <li>
                                        Implementation and deployment of
                                        projects on live production environment
                                        servers
                                    </li>
                                </ul>
                            </CardContent>
